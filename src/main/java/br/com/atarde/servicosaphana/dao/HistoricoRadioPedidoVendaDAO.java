...
public class HistoricoRadioPedidoVendaDAO {
	...
	public HistoricoRadioPedidoVenda inserirInterface(HistoricoRadioPedidoVenda model) throws TSApplicationException {
		...
		for (PedidoVendaLinhaAB item : model.getLinhas()) {
			...
			RadioPedidoVendaLinha linha = (RadioPedidoVendaLinha) item;

			linha.setPedidoVenda(new RadioPedidoVenda("interfaceId", model.getInterfaceId()));

			new HistoricoRadioPedidoVendaLinhaDAO().inserirInterface(linha, broker);
