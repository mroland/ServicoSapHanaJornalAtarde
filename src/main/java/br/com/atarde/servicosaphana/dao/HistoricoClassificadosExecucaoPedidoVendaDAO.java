...
public class HistoricoClassificadosExecucaoPedidoVendaDAO {
	...
	public HistoricoClassificadosExecucaoPedidoVenda inserirInterface(HistoricoClassificadosExecucaoPedidoVenda model) throws TSApplicationException {
		...
		for (PedidoVendaLinhaAB item : model.getLinhas()) {
			...
			ClassificadosExecucaoPedidoVendaLinha linha = (ClassificadosExecucaoPedidoVendaLinha) item;

			linha.setPedidoVenda(new ClassificadosExecucaoPedidoVenda("interfaceId",model.getInterfaceId()));
			
			new HistoricoClassificadosExecucaoPedidoVendaLinhaDAO().inserirInterface(linha,broker);
