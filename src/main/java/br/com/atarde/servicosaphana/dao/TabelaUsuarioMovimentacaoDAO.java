...
public class TabelaUsuarioMovimentacaoDAO {
	...
	public List<TabelaUsuarioMovimentacao> pesquisarInterface(TabelaUsuarioMovimentacao model) {
		...
		sql.append("SELECT ID, ITEM_ID, QUANTIDADE, TIPO_MOVIMENTACAO_ID, ID_EXTERNO, EMPRESA_ID, FILIAL_ID, DATA_EXPORTACAO, NOTA_FISCAL_SAIDA_REFERENCIA_ID, SAP_TABELA_USUARIO_ID, STATUS_ID, ARQUIVO_REMESSA, SAP_NOTA_FISCAL_SAIDA_ID, SAP_DEVOLUCAO_NOTA_FISCAL_SAIDA_ID FROM TABELA_USUARIO_MOVIMENTACAO M WHERE AND STATUS_ID !=2 ");
