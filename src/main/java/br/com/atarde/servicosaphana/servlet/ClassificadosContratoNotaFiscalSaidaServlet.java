 ...
 */
@WebServlet("/ClassificadosContratoNotaFiscalSaidaServlet")
public class ClassificadosContratoNotaFiscalSaidaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ClassificadosContratoNotaFiscalSaidaServlet() {
		super();
	...
	private void processar(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (TSUtil.isEmpty(empresaId)) {
			...
			if (TSUtil.isEmpty(empresa)) {
				...
				new ClassificadosContratoNotaFiscalSaidaBusiness().inserirSAP(empresa);
