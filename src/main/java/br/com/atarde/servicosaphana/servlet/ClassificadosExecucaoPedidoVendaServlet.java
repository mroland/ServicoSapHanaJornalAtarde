...
/**
 * Servlet implementation class ClassificadosExecucaoPedidoVendaServlet
 */
@WebServlet("/ClassificadosExecucaoPedidoVendaServlet")
public class ClassificadosExecucaoPedidoVendaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ClassificadosExecucaoPedidoVendaServlet() {
		super();
	...
	private void processar(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (TSUtil.isEmpty(empresaId)) {
			...
			if (TSUtil.isEmpty(empresa)) {
				...
				new ClassificadosExecucaoPedidoVendaBusiness().inserirSAP(empresa);
