...
/**
 * Servlet implementation class EasyclassPedidoVendaServlet
 */
@WebServlet("/EasyclassPedidoVendaServlet")
public class EasyclassPedidoVendaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public EasyclassPedidoVendaServlet() {
		super();
	...
	private void processar(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (TSUtil.isEmpty(empresaId)) {
			...
			if (TSUtil.isEmpty(empresa)) {
				...
				new EasyclassPedidoVendaBusiness().inserirSAP(empresa);
