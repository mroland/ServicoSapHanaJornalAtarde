...
/**
 * Servlet implementation class RadioPedidoVendaServlet
 */
@WebServlet("/RadioPedidoVendaServlet")
public class RadioPedidoVendaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public RadioPedidoVendaServlet() {
		super();
	...
	private void processar(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (TSUtil.isEmpty(empresaId)) {
			...
			if (TSUtil.isEmpty(empresa)) {
				...
				new RadioPedidoVendaBusiness().inserirSAP(empresa);
