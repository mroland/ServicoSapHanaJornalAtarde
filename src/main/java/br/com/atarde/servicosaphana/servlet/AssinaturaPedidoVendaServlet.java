 ...
 */
@WebServlet("/AssinaturaPedidoVendaServlet")
public class AssinaturaPedidoVendaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AssinaturaPedidoVendaServlet() {
		super();
	...
	private void processar(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (TSUtil.isEmpty(empresaId)) {
			...
			if (TSUtil.isEmpty(empresa)) {
				...
				new AssinaturaPedidoVendaBusiness().inserirSAP(empresa);
