 ...
 */
@WebServlet("/ClassificadosContratoPedidoVendaServlet")
public class ClassificadosContratoPedidoVendaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ClassificadosContratoPedidoVendaServlet() {
		super();
	...
	private void processar(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (TSUtil.isEmpty(empresaId)) {
			...
			if (TSUtil.isEmpty(empresa)) {
				...
				new ClassificadosContratoPedidoVendaBusiness().inserirSAP(empresa);
