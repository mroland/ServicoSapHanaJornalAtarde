...
public class ClassificadosExecucaoNotaFiscalSaida extends NotaFiscalSaidaAB implements Serializable {
	...
	private List<ClassificadosExecucaoNotaFiscalSaidaLinha> linhas;
	...
	public List<ClassificadosExecucaoNotaFiscalSaidaLinha> getLinhas() {
		return linhas;
	}

	public void setLinhas(List<ClassificadosExecucaoNotaFiscalSaidaLinha> linhas) {
		this.linhas = linhas;
	}
