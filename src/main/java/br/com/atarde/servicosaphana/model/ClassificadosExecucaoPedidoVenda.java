...
@XmlRootElement
public class ClassificadosExecucaoPedidoVenda extends PedidoVendaAB implements Serializable {
	...
	private List<ClassificadosExecucaoPedidoVendaLinha> linhas;
	...
	public ClassificadosExecucaoPedidoVenda() {
	}

	public ClassificadosExecucaoPedidoVenda(Status status) {

		this.setStatus(status);

	}

	public ClassificadosExecucaoPedidoVenda(Empresa empresa) {
		this.setEmpresa(empresa);
	}

	public ClassificadosExecucaoPedidoVenda(String atributo, Long valor) {
	...
	public List<ClassificadosExecucaoPedidoVendaLinha> getLinhas() {
		return linhas;
	}

	public void setLinhas(List<ClassificadosExecucaoPedidoVendaLinha> linhas) {
		this.linhas = linhas;
	}
