...
@XmlRootElement
public class ClassificadosContratoPedidoVenda extends PedidoVendaAB implements Serializable {
    ...
    private List<ClassificadosContratoPedidoVendaLinha> linhas;
    ...
    public ClassificadosContratoPedidoVenda() {
    }
    
    public ClassificadosContratoPedidoVenda(Status status) {
        
        this.setStatus(status);
        
    }

    public ClassificadosContratoPedidoVenda(Empresa empresa) {
		this.setEmpresa(empresa);
	}

	public ClassificadosContratoPedidoVenda(String atributo, Long valor) {
	...
	public List<ClassificadosContratoPedidoVendaLinha> getLinhas() {
		return linhas;
	}

	public void setLinhas(List<ClassificadosContratoPedidoVendaLinha> linhas) {
		this.linhas = linhas;
	}
