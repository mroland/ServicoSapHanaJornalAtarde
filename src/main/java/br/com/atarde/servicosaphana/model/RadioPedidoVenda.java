...
public class RadioPedidoVenda extends PedidoVendaAB implements Serializable {
	...
	private List<RadioPedidoVendaLinha> linhas;
	...
	public RadioPedidoVenda(Status status) {

		this.setStatus(status);

	}

	public RadioPedidoVenda(Empresa empresa) {
		this.setEmpresa(empresa);
	}

	public RadioPedidoVenda(String atributo, Long valor) {
	...
	public void setLinhas(List<RadioPedidoVendaLinha> linhas) {
		this.linhas = linhas;
	}
