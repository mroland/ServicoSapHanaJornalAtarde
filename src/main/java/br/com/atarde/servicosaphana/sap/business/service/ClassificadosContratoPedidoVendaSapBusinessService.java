...
import br.com.atarde.servicosaphana.sap.hana.model.ClassificadosContratoPedidoVendaLinhaModel;
import br.com.atarde.servicosaphana.sap.hana.model.ClassificadosContratoPedidoVendaModel;
 ...
 * @author mroland
 */
public class ClassificadosContratoPedidoVendaSapBusinessService {
	...
	public ClassificadosContratoPedidoVenda inserir(ClassificadosContratoPedidoVenda model) throws Exception {

		this.initObjetosNaRequisicao(model.getEmpresa());

		ClassificadosContratoPedidoVendaModel nffJson = new ClassificadosContratoPedidoVendaModel();
		...
		if (TSUtil.isEmpty(nffJson.getLinhas())) {
			...
			nffJson.setLinhas(new ArrayList<ClassificadosContratoPedidoVendaLinhaModel>());

		}

		ClassificadosContratoPedidoVendaLinhaModel linhaJson;
		for (ClassificadosContratoPedidoVendaLinha linha : model.getLinhas()) {

			linhaJson = new ClassificadosContratoPedidoVendaLinhaModel();
	...
	private ClassificadosContratoPedidoVendaModel inserir(ClassificadosContratoPedidoVendaModel model, ConexaoSessaoHanaModel conexaoSessaoHanaModel) throws Exception {
		...
		ClassificadosContratoPedidoVendaModel resposta;
		...
		if (response.getStatusInfo().getStatusCode() == 200 || response.getStatusInfo().getStatusCode() == 201) {
			...
			resposta = new Gson().fromJson(json, ClassificadosContratoPedidoVendaModel.class);
