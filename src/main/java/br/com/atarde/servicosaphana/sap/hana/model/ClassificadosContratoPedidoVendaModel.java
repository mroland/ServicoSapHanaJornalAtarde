...
public class ClassificadosContratoPedidoVendaModel extends PedidoVendaModel {

	@SerializedName("DocumentLines")
	private List<ClassificadosContratoPedidoVendaLinhaModel> linhas;
	...
	public void setLinhas(List<ClassificadosContratoPedidoVendaLinhaModel> linhas) {
		this.linhas = linhas;
	}
