...
public class RadioPedidoVendaModel extends PedidoVendaModel {

	@SerializedName("DocumentLines")
	private List<RadioPedidoVendaLinhaModel> linhas;
	...
	public void setLinhas(List<RadioPedidoVendaLinhaModel> linhas) {
		this.linhas = linhas;
	}
